...
import heroBurger from '../assets/about-us.jpg';
  ...
  return (
    ...
    >
      <div className="text-center text-white bg-gray-900 bg-opacity-50 p-8 rounded-lg">
        ...
        <a href="/menu" className="bg-accent text-white font-bold py-3 px-8 rounded-lg hover:bg-primary-bg transition duration-300 hero-button">View Menu</a>
      </div>
    </section>
  );
}
